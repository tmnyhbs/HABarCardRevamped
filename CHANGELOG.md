...
- **Zone coloration** — five-zone color system (danger/warning/OK/warning/danger) with 4 configurable thresholds and 3 colors, settable per-entity. Same logic as [Zone Tile Card](https://github.com/tmnyhbs/ZoneTileCardForHomeAssistant), with color pickers in the visual editor.
